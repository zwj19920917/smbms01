...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
			...
			<input type="hidden" id="totalPageCount" value="${pagging.totalPageCount}"/>
		  	<c:import url="rollpage.jsp">
	          	<c:param name="totalCount" value="${pagging.totalCount}"/>
	          	<c:param name="currentPageNo" value="${pagging.currentPageNo}"/>
	          	<c:param name="totalPageCount" value="${pagging.totalPageCount}"/>
          	</c:import>
        </div>
    </section>
